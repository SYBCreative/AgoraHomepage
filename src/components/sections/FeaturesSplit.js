...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: "The Music Festival, Virtualized",
    paragraph:
      "The spectacle, exhilaration, social connection, and artistry of a live festival, virtualized and scaled as a digital platform.",
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12">Any Platform</h3>
                <p className="m-0">Designed for TV, Web, Mobile and VR</p>
              </div>
              <div
                className={classNames(
                  "split-item-image center-content-mobile reveal-from-bottom",
